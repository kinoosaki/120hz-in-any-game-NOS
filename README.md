...
**STEP 1:** Tap on the plus button you see at the bottom right, and then tap on "create" when this popup comes up. You can tap on "stop reminding" and it won't come up in the future.
...
**STEP 2:** Next tap on "application"
...
**STEP 3:** Tap on the game you want to run at 120hz and then go back. We're using Geometry Dash here as an example.
...
**STEP 5:** Tap on the plus button here
...
**STEP 6:** (the list will be longer for you lmao as I used the search feature like you can see) Tap on "run shell" here.
